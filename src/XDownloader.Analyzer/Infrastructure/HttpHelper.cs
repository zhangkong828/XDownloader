...
namespace XDownloader.Analyzer.Infrastructure
{
        ...
        public static string Get(string url, Dictionary<string, string> headers = null)
        {
            ...
            try
            {
                ...
                if (headers==null)
                {
                    ...
                    headers.Add("UserAgent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.101 Safari/537.36");
                }
